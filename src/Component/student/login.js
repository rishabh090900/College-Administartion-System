...
class Login extends Component {
    ...
    axios.post('http://localhost:4000/api/slogin',body1)
    .then(response => sessionStorage.setItem("stoken",response.data.token))
.then(localStorage.setItem("student",this.state.email))    
    this.setState({
        loggedIn:true
    })
}
    ...
    render () {
      ...
      return (
          <div style={{height:"969px" , backgroundImage:'url("student.jpg")',backgroundSize:"1920px"}}>
               <h1 style={{fontFamily:"serif",fontSize:"60px",padding:"30px", color:"whitesmoke"}}>College Administartion System</h1>
