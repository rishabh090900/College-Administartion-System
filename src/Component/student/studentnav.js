...
import StudentA from './studentaccount'
  ...
  return (
    <Router>
      ...
      <Drawer
        ...
        <ListItem button key='studentdash'>
      ...
      <Switch>
      <Route path="/student/studentdash" component={StudentA}/>
      <Route path="/student/courses" component={Course}/>
      <Route path="/student/course/coursepage" component={Coursepage}/>
